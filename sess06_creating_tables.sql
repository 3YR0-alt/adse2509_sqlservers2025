/* Session 06 covers how to create, modify and delete (drop) tables and
their columns in SQL Server. */
...
--Make changes/modify an existing table
...
update Buddies
set Buddy_Nickname = 'P.P' -- Change Peter's nickname from 'Peter' to 'P.P'
...
-- Truncate (delete alll records from a table) the buddies table
